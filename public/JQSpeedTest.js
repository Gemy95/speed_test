...
JQSpeedTest = function(options) {
	...
	function TestDownload(){
		...
		$.ajax({
			...
			//url :"https://images.pexels.com/photos/1236701/pexels-photo-1236701.jpeg?cs=srgb&dl=photography-of-person-walking-on-road-1236701.jpg&fm=jpg",
			//url :'https://images.pexels.com/photos/1236701/pexels-photo-1236701.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260',
			timeout: 60000,
			cache: false,
			retries       : 3,     //       <-------- Optional
	...
	function TestUpload(){
		...
		$.ajax({
			type: "POST",
            url : "https://speedtestapis.herokuapp.com/uploadData",
			//url: "/uploadData",
			data: randData,
			timeout: 60000,
			cache: false,
	...
	function TestResponse(){
		...
		$.ajax({
			type: "HEAD",
			url: "https://speedtestapis.herokuapp.com/getResponseTime",
			timeout: 60000,
			cache: false,
			retries       : 3,     //       <-------- Optional
			retryInterval : 2000,   //       <-------- Optional
